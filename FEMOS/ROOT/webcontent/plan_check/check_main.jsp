                ...
                <div class="check">
                   <div style="background:#f2f2f2;padding:5px;">
					 ...
					 <div style="margin-top:10px;padding:5px;text-align:center;">
	                	<a href="javascript:show_layout_form('check_div_input_form');">[그룹추가]</a>
	                	<a href="javascript:setCheckDivEditForm('<%=check_cd %>','<%= parent_check_cd%>','<%= check_nm%>','<%=leaf %>');">[그룹편집]</a>
	                	<%if(check_cd.length() > 0){ %>
	                	<a href="javascript:show_layout_form('check_item_input_form');">[체크항목등록]</a>
	                	<%} %>
	                </div>
                </div>
