...
<%
	...
	String st_yyyymmddhhmi = obj.getSt_year() + obj.getSt_month() + obj.getSt_day() + obj.getSt_hour() + obj.getSt_minute();
	String ed_yyyymmddhhmi = obj.getEd_year() + obj.getEd_month() + obj.getEd_day() + obj.getEd_hour() + obj.getEd_minute();
	
	Biz_schedule_plan st_add_date = schedule.getAddDate(st_yyyymmddhhmi,day,minute);
	
	Biz_schedule_plan ed_add_date = schedule.getAddDate(ed_yyyymmddhhmi,day,minute);
	
	schedule.updateSchedule_date(pk_id,"ST",st_add_date.getYyyy(),st_add_date.getMm(),st_add_date.getDd(),st_add_date.getHh(),st_add_date.getMi());
