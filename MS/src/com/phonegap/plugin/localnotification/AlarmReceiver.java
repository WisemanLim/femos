...
import kr.ac.joongbu.femos.ms.MSMain;
import kr.ac.joongbu.femos.ms.MSTapping;
import kr.ac.joongbu.femos.ms.R;
...
public class AlarmReceiver extends BroadcastReceiver {
	...
	public void onReceive(Context context, Intent intent) {
		...
		final PendingIntent contentIntent = PendingIntent.getActivity(context, 0, new Intent(context, MSMain.class), 0);
//		Intent notificationIntent = new Intent(context, MSTapping.class);
